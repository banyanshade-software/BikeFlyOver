...
| F-08 |v1  | Timeline | Add a timeline slider for current track position | Explicitly requested in the GUI spec | Not implemented |
...
| F-18 |v1  | Media | Import photos and videos into the project | Required by the spec | Not implemented |
| F-19 |v1  | Media | Read EXIF timestamps from photos and videos | Required for automatic placement | Not implemented |
...
| F-55 |v1  | Bug fix | Prevent the track line from visually floating too high above the ground or terrain | Fixes an obvious visual defect in route rendering | Partial |
| F-56 |v1  | Bug fix | Ensure route markers and played-route highlight stay aligned with the same altitude/terrain strategy as the base track | Avoids mismatched route geometry during playback | Partial |
